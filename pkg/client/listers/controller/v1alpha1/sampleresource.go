...
type SampleResourceLister interface {
	...
	List(selector labels.Selector) (ret []*v1alpha1.SampleResource, err error)
...
// List lists all SampleResources in the indexer.
func (s *sampleResourceLister) List(selector labels.Selector) (ret []*v1alpha1.SampleResource, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.SampleResource))
	})
	return ret, err
}
...
type SampleResourceNamespaceLister interface {
	...
	Get(name string) (*v1alpha1.SampleResource, error)
...
// List lists all SampleResources in the indexer for a given namespace.
func (s sampleResourceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.SampleResource, err error) {
...
// Get retrieves the SampleResource from the indexer for a given namespace and name.
func (s sampleResourceNamespaceLister) Get(name string) (*v1alpha1.SampleResource, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("sampleresource"), name)
	}
	return obj.(*v1alpha1.SampleResource), nil
}
